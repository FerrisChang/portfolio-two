...
const Contact = () => {
  ...
  const authorize = async() => {
    try {
      const auth = await axios.get('https://portfolio-two-4bec.onrender.com:3000/authorize')
  ...
  const sendEmail = async(e) => {
    ...
    try {
      const data = await axios.post('https://portfolio-two-4bec.onrender.com:3000/send-email', formData)
